...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        ...
        self.lblDigonosis = Label(self, text="Digonosis",width=15,bg="bisque")
        ...
        self.btnNo=Button(self,text="No",width=15,bg="bisque", command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=15,bg="bisque", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=15,bg="bisque", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=15,bg="bisque", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        master.title("Account Login [Login/ Register]")
        self.createWidget()
    def createWidget(self):
        self.lblMsg = Label(self, text="APEX - Health Care Chatbot", bg="#90EE90", width="170", height="2",
                            font=("Calibri", 15))
        self.lblMsg.pack()
        self.btnLogin = Button(self, text="Login", height="5", width="170", font=("calibri",12),bg="#FFF8DC", command=self.lblLogin_Click)
        self.btnLogin.pack()
        # self.btnLogin.place(x=5, y=5)
        self.btnRegister = Button(self, text="Register", height="5", width="170",font=("calibri",12),bg="#AFEEEE", command=self.btnRegister_Click)
        self.btnRegister.pack()
        # self.btnRegister.place(x=10, y=5)
        self.lblTeam = Label(self, text="Made by:", bg="slateblue4", width="250", height="2", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1 = Label(self, text="Raghu Ram Vadlamudi", bg="RoyalBlue1", width="250", height="1",
                              font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2 = Label(self, text="Ranjit Banerjee", bg="RoyalBlue2", width="250", height="1",
                              font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3 = Label(self, text="Harsh Raj", bg="RoyalBlue3", width="250", height="1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4 = Label(self, text="Arthi Dharma", bg="RoyalBlue4", width="250", height="1", font=("Calibri", 13))
        self.lblTeam4.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="#E9967A")
        self.lblMsg.pack()
        ...
        self.btnLogin=Button(self, text="Login", width=10, height=2, bg="#7cfc00", command=self.btnLogin_Click)
        self.btnLogin.pack()
...
#        messagebox.showinfo("Failure", self.username1+":"+password1)
        ...
        if username1 in list_of_files:
            ...
            if password1 in verify:
                ...
                messagebox.showinfo("Failure", "Login Details are incorrect try again")
        else:
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below", bg="#f0e68c")
        self.lblMsg.pack()
        ...
        self.btnRegister=Button(self, text="Register", width=10, height=1, bg="#7cfc00", command=self.register_user)
        self.btnRegister.pack()
    ...
    def register_user(self):
        ...
        self.lblSucess=Label(root, text="Registration Success", fg="green", font=("calibri", 15))
        self.lblSucess.pack()
